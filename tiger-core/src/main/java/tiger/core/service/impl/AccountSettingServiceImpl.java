...
import tiger.common.dal.persistence.AccountSettingMapper;
import tiger.common.dal.query.AccountSettingQuery;
import tiger.core.domain.AccountSettingDomain;
import tiger.core.domain.convert.AccountSettingConvert;
...
public class AccountSettingServiceImpl implements AccountSettingService {
     ...
     */
    @Override
    public List<AccountSettingListDomain> query(AccountSettingQuery settingQuery) {
        if (settingQuery == null) {
            return null;
        }

        return AccountSettingConvert.convert2ListDomains(
