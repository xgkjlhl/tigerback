 ...
 */
public class LoanPawnCreateForm extends BaseForm implements FormInterface {
    ...
    @CopyIgnore
    private List<AttachRelateForm> loanPawnAttaches;
    ...
    public List<AttachRelateForm> getLoanPawnAttaches() {
        return loanPawnAttaches;
    }

    public void setLoanPawnAttaches(List<AttachRelateForm> loanPawnAttaches) {
        this.loanPawnAttaches = loanPawnAttaches;
    }
    ...
    public LoanPawnDomain convert2Domain() {
        ...
        if (!CollectionUtils.isEmpty(this.loanPawnAttaches)) {
            List<AttachRelateDomain> attachDomains = new ArrayList<>(this.loanPawnAttaches.size());
            this.loanPawnAttaches.forEach(attachRelateForm -> attachDomains.add(attachRelateForm.convert2Domain()));
            domain.setLoanPawnAttachDomains(attachDomains);
        }
