...
import tiger.common.util.ObjectUtil;
...
public class RedisAspect {
    ...
    public Object around(ProceedingJoinPoint p) throws Throwable {
        ...
        if (StringUtil.isNotBlank(content)) {
            ...
            if (ObjectUtil.isBaseDataType(signature.getReturnType())) {
                return ObjectUtil.convertToBaseData(content, signature.getReturnType());
            } else {
