...
public class BaseController {
     ...
     * @return
     */
    public WorkspaceDomain currentWorkspace(){
        for(WorkspaceDomain workspaceDomain: currentAccount().getWorkspaces()){
            if(workspaceDomain.getId().equals(currentWorkspaceId()))
